               ...
               <div class="card">
                <div class="card-header">
                  ...
                  <div class="pull-right">
                    <a href="{{ url('reportk')}}" class="btn btn-success btn-sm">
                  ...
                  <div class="row">
                    <div class="col-md-4 offset-md-4">
                      <form action="{{url('report')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <table>Hasil Laporan</table>
                          <input type="text" name="hasil" class="form-control @error('hasil') is-invalid @enderror" value="{{old('hasil')}}" autofocus>
                          @error('hasil')
                          <div class="invalid-feedback">{{$message}}</div>
                          @enderror
                        </div>
                        <div class="form-group">
                          <table>Bukti Laporan</table>
                        ...
                        <div class="form-group">
                              <table>Status Laporan Upload Facebook</table>
